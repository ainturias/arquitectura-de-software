...
class PAsistencia extends VistaBase
{
    ...
    /**
     * Renderiza un encabezado HTML minimalista, ideal para móviles.
     */
            ...
            <div class="col-12 col-md-8 col-lg-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h3 class="text-center my-2">Registrar Asistencia</h3>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form method="POST">
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" value="marcar" class="btn btn-success btn-lg">Registrar Asistencia</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    /**
     * Función de ayuda para mostrar mensajes de alerta de forma consistente.
     */
